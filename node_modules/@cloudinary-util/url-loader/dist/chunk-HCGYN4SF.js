...
var rawTransformationsProps = {
  rawTransformations: z7.union([RawTransformationSchema, z7.array(RawTransformationSchema)]).describe(
    JSON.stringify({
...
var removeBackgroundProps = {
  removeBackground: z8.boolean().describe(
    JSON.stringify({
...
var underlaysProps = {
  underlay: z11.string().describe(
    JSON.stringify({
      text: "Public ID of image that is applied under the base image.",
      url: "https://cloudinary.com/documentation/transformation_reference#l_layer"
    })
  ).optional(),
  underlays: z11.array(underlaySchema).describe(
    JSON.stringify({
...
var versionProps = {
  version: z12.union([z12.number(), z12.string()]).describe(
    JSON.stringify({
...
var assetOptionsSchema = z13.object({
  ...
  width: z13.union([z13.string(), z13.number()]).describe(
    JSON.stringify({
...
var defaultImageProps = {
  defaultImage: z14.string().describe(
    JSON.stringify({
...
var imageOptionsRecolorPromptSchema = z17.union([
  z17.string(),
  z17.array(z17.string())
]);
var imageOptionsRecolorSchema = z17.object({
  prompt: imageOptionsRecolorPromptSchema.optional(),
  to: z17.string().optional(),
  multiple: z17.boolean().optional()
});
var recolorProps = {
  recolor: z17.union([imageOptionsRecolorPromptSchema, imageOptionsRecolorSchema]).describe(
    JSON.stringify({
...
var imageOptionsRemovePromptSchema = z18.union([
  z18.string(),
  z18.array(z18.string())
]);
var imageOptionsRemoveSchema = z18.object({
  prompt: imageOptionsRemovePromptSchema.optional(),
  region: z18.union([z18.array(z18.number()), z18.array(z18.array(z18.number()))]).optional(),
  multiple: z18.boolean().optional(),
  removeShadow: z18.boolean().optional()
});
var removeProps = {
  remove: z18.union([imageOptionsRemovePromptSchema, imageOptionsRemoveSchema]).describe(
    JSON.stringify({
...
var replaceProps = {
  replace: z19.union([
    ...
    z19.array(z19.boolean()),
    z19.object({
      to: z19.string(),
      from: z19.string(),
      preserveGeometry: z19.boolean().optional()
    })
  ]).describe(
    JSON.stringify({
...
var replaceBackgroundProps = {
  replaceBackground: z20.union([
    z20.boolean(),
    z20.string(),
    z20.object({
      seed: z20.number().optional(),
...
var abrProps = {
  streamingProfile: z24.string().describe(
    JSON.stringify({
...
var analyticsOptionsSchema = z26.any();

// src/types/config.ts
import { z as z27 } from "zod";
var configOptionsSchema = z27.any();
...
var constructUrlOptionsSchema = z28.union([imageOptionsSchema, videoOptionsSchema]).describe(
  JSON.stringify({
...
var constructUrlPropsSchema = z28.object({
  analytics: z28.union([analyticsOptionsSchema, z28.boolean()]).describe(
    JSON.stringify({
