...
var NamedTransformationSchema = import_zod9.z.string();
var namedTransformationsProps = {
  namedTransformations: import_zod9.z.union([NamedTransformationSchema, import_zod9.z.array(NamedTransformationSchema)]).describe(
    JSON.stringify({
   ...
   */
  transformations: import_zod9.z.union([NamedTransformationSchema, import_zod9.z.array(NamedTransformationSchema)]).describe(
    JSON.stringify({
...
var overlayTextSchema = import_zod10.z.object({
  alignment: import_zod10.z.string().optional(),
  antialias: import_zod10.z.string().optional(),
  border: import_zod10.z.string().optional(),
  color: import_zod10.z.string().optional(),
  fontFamily: import_zod10.z.string().optional(),
  fontSize: import_zod10.z.number().optional(),
  fontStyle: import_zod10.z.union([import_zod10.z.string(), import_zod10.z.number()]).optional(),
  fontWeight: import_zod10.z.string().optional(),
  hinting: import_zod10.z.union([import_zod10.z.string(), import_zod10.z.number()]).optional(),
  letterSpacing: import_zod10.z.union([import_zod10.z.string(), import_zod10.z.number()]).optional(),
  lineSpacing: import_zod10.z.union([import_zod10.z.string(), import_zod10.z.number()]).optional(),
  stroke: import_zod10.z.string().optional(),
  text: import_zod10.z.string()
  // Required if using object format
});
var overlayPositionSchema = import_zod10.z.object({
  angle: angle.schema.optional(),
  gravity: gravity.schema.optional(),
  x: x.schema.optional(),
  y: y.schema.optional()
});
var overlaySchema = import_zod10.z.object({
  appliedEffects: import_zod10.z.array(import_zod10.z.object({})).optional(),
  appliedFlags: flags.schema.optional(),
  effects: import_zod10.z.array(import_zod10.z.object({})).optional(),
  crop: crop.schema.optional(),
  flags: flags.schema.optional(),
  height: height.schema.optional(),
  position: overlayPositionSchema.optional(),
  publicId: import_zod10.z.string().optional(),
  text: import_zod10.z.union([import_zod10.z.string(), overlayTextSchema]).optional(),
...
var overlaysProps = {
  ...
  overlays: import_zod10.z.array(overlaySchema).describe(
    JSON.stringify({
      text: "Image or text layers that are applied on top of the base image.",
      url: "https://cloudinary.com/documentation/transformation_reference#l_layer"
    })
  ).optional(),
  text: import_zod10.z.string().describe(
    JSON.stringify({
...
var RawTransformationSchema = import_zod11.z.string();
var rawTransformationsProps = {
  rawTransformations: import_zod11.z.union([RawTransformationSchema, import_zod11.z.array(RawTransformationSchema)]).describe(
    JSON.stringify({
...
var imageOptionsRecolorPromptSchema = import_zod12.z.union([
  import_zod12.z.string(),
  import_zod12.z.array(import_zod12.z.string())
]);
var imageOptionsRecolorSchema = import_zod12.z.object({
  prompt: imageOptionsRecolorPromptSchema.optional(),
  to: import_zod12.z.string().optional(),
  multiple: import_zod12.z.boolean().optional()
});
var recolorProps = {
  recolor: import_zod12.z.union([imageOptionsRecolorPromptSchema, imageOptionsRecolorSchema]).describe(
    JSON.stringify({
...
var removeBackgroundProps = {
  removeBackground: import_zod13.z.boolean().describe(
    JSON.stringify({
...
var imageOptionsRemoveSchema = import_zod14.z.object({
  ...
  region: import_zod14.z.union([import_zod14.z.array(import_zod14.z.number()), import_zod14.z.array(import_zod14.z.array(import_zod14.z.number()))]).optional(),
  multiple: import_zod14.z.boolean().optional(),
  removeShadow: import_zod14.z.boolean().optional()
});
var removeProps = {
  remove: import_zod14.z.union([imageOptionsRemovePromptSchema, imageOptionsRemoveSchema]).describe(
    JSON.stringify({
...
var replaceProps = {
  replace: import_zod15.z.union([
    import_zod15.z.array(import_zod15.z.string()),
    import_zod15.z.array(import_zod15.z.boolean()),
    import_zod15.z.object({
      to: import_zod15.z.string(),
      from: import_zod15.z.string(),
      preserveGeometry: import_zod15.z.boolean().optional()
    })
  ]).describe(
    JSON.stringify({
...
var replaceBackgroundProps = {
  replaceBackground: import_zod16.z.union([
    import_zod16.z.boolean(),
    import_zod16.z.string(),
    import_zod16.z.object({
      seed: import_zod16.z.number().optional(),
      prompt: import_zod16.z.string().optional()
    })
  ]).describe(
    JSON.stringify({
...
var restoreProps = {
  restore: import_zod17.z.boolean().describe(
    JSON.stringify({
...
var sanitizeProps = {
  sanitize: import_zod18.z.boolean().describe(
    JSON.stringify({
...
var seoProps = {
  seoSuffix: import_zod19.z.string().describe(
    JSON.stringify({
...
var underlayPositionSchema = import_zod20.z.object({
  angle: angle.schema.optional(),
  gravity: gravity.schema.optional(),
  x: x.schema.optional(),
  y: y.schema.optional()
});
var underlaySchema = import_zod20.z.object({
  appliedEffects: import_zod20.z.array(import_zod20.z.object({})).optional(),
  appliedFlags: flags.schema.optional(),
  effects: import_zod20.z.array(import_zod20.z.object({})).optional(),
  crop: crop.schema.optional(),
  flags: flags.schema.optional(),
  height: height.schema.optional(),
  position: underlayPositionSchema.optional(),
  publicId: import_zod20.z.string().optional(),
  type: import_zod20.z.string().optional(),
  url: import_zod20.z.string().optional(),
  width: width.schema.optional()
});
var underlaysProps = {
  underlay: import_zod20.z.string().describe(
    JSON.stringify({
      text: "Public ID of image that is applied under the base image.",
      url: "https://cloudinary.com/documentation/transformation_reference#l_layer"
    })
  ).optional(),
  underlays: import_zod20.z.array(underlaySchema).describe(
    JSON.stringify({
...
var underlaysPlugin = {
  ...
  plugin: ({ cldAsset, options }) => {
    ...
    function applyUnderlay({
      ...
      const applied = [];
      Object.keys(options2).forEach((key) => {
        if (!(0, import_util4.objectHasKey)(primary, key)) return;
      ...
      if (hasPosition) {
        Object.keys(position2).forEach(
          (key) => {
            if (!(0, import_util4.objectHasKey)(position, key)) return;
...
var analyticsOptionsSchema = import_zod22.z.any();

// src/types/config.ts
var import_zod23 = require("zod");
var configOptionsSchema = import_zod23.z.any();
...
var versionProps = {
  version: import_zod24.z.union([import_zod24.z.number(), import_zod24.z.string()]).describe(
    JSON.stringify({
...
// src/types/asset.ts
var assetOptionsSchema = import_zod25.z.object({
  assetType: import_zod25.z.string().default("image").describe(
    JSON.stringify({
      text: "The type of asset to deliver.",
      url: "https://cloudinary.com/documentation/image_transformations#transformation_url_structure"
    })
  ).optional(),
  deliveryType: import_zod25.z.string().default("upload").describe(
    JSON.stringify({
      text: "Delivery method of the asset.",
      url: "https://cloudinary.com/documentation/image_transformations#delivery_types"
    })
  ).optional(),
  dpr: import_zod25.z.union([import_zod25.z.string(), import_zod25.z.number()]).describe(
    JSON.stringify({
      text: "Delivery method of the asset.",
      url: "https://cloudinary.com/documentation/image_transformations#delivery_types"
    })
  ).optional(),
  format: import_zod25.z.string().default("auto").describe(
    JSON.stringify({
      text: "Converts (if necessary) and delivers an asset in the specified format.",
      url: "https://cloudinary.com/documentation/transformation_reference#f_format"
    })
  ).optional(),
  height: import_zod25.z.union([import_zod25.z.string(), import_zod25.z.number()]).describe(
    JSON.stringify({
      text: "Height of the given asset."
    })
  ).optional(),
  quality: import_zod25.z.union([import_zod25.z.string(), import_zod25.z.number(), import_zod25.z.string()]).default("auto").describe(
    JSON.stringify({
      text: "Quality of the delivered asset",
      url: "https://cloudinary.com/documentation/transformation_reference#q_quality"
    })
  ).optional(),
  src: import_zod25.z.string().describe(
    JSON.stringify({
      text: "Cloudinary Public ID or versioned Cloudinary URL (/v1234/)"
    })
  ),
  strictTransformations: import_zod25.z.boolean().describe(
    JSON.stringify({
  ...
  width: import_zod25.z.union([import_zod25.z.string(), import_zod25.z.number()]).describe(
    JSON.stringify({
...
var constructUrlOptionsSchema = import_zod28.z.union([imageOptionsSchema, videoOptionsSchema]).describe(
  JSON.stringify({
...
var constructUrlPropsSchema = import_zod28.z.object({
  analytics: import_zod28.z.union([analyticsOptionsSchema, import_zod28.z.boolean()]).describe(
    JSON.stringify({
...
function constructCloudinaryUrl({
  ...
  Object.keys(parsedOptions).forEach(
    (key) => {
      if ((0, import_util5.objectHasKey)(options, key)) return;
